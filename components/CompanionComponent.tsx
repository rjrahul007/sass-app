...
const CompanionComponent = ({name, subject, title, topic, duration, companionId, userName, userImage, style, voice}: CompanionComponentProps) => {
...
useEffect(() => {
    ...
    const onError = (error: string) => console.error('Error:', error)
    ...
    const onCallInactive = () => setcallStatus(CallStatus.INACTIVE)
...
return () => {
    ...
    vapi.off('call-connecting', onCallConnecting)
    vapi.off('call-inactive', onCallInactive)
  }
